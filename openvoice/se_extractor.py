...
def split_audio_whisper(audio_path, audio_name, target_dir='processed'):
    ...
    for k, w in enumerate(segments):
        ...
        audio_seg = audio[ start_time * 1000 : min(max_len, end_time * 1000 + 80)]
        start_ends.append((start_time * 1000, end_time * 1000 + 80))
